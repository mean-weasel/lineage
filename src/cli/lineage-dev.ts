...
This package includes a public development CLI bridge, but command implementations are not bundled yet.
...
const message = 'Lineage development CLI bridge is installed, but this command is not implemented in the public package yet.';
